...
console.log(greeting.slice(5,13))
...
let wordtwenty= 'is'
let wordnineteen= 'my'
let wordfifteen= 'favorite'
let wordeighteen= 'to'
let wordthirteen= 'eat'
//let templateLiteral=($pizza$is$my$favorite$to$eat)

// 4. Given the string of your full name get your initials.
let myName="Lexi Rochell"
